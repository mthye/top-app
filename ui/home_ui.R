  ...
  fluidRow(
    column(width = 6,
           infoBox(
             ...
             value = HTML("<h5 style>The session will time out after an hour, so remember to save your work periodically by clicking the <b>Save Progress</b> button at the top of the page.<br><br>
