...
`r if(params$Q5 == "Not Applicable"){"The authors indicated that reporting the sample size determination, data exclusions, and inclusion and exclusion criteria was not applicable to this research. They provided the following justification:"}` `r shQuote(params$Q5_popup)`
