...
`r if(params$S2_output == "D"){"DATA: No raw or processed data supporting this research are publicly available. The authors provided the following justification:"}` `r data_text`
...
`r if(params$S3_output == "D"){"CODE: No analysis code supporting this research is publicly available. The authors provided the following justification:"}` `r code_text`
...
`r if(params$S4_output == "E"){"MATERIALS: No study materials supporting this research are publicly available. The authors provided the following justification:"}` `r mat_text`
